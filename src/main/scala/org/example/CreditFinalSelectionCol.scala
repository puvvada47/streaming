...
object CreditFinalSelectionCol {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val requestStructType=DataType.fromJson(requestSchemaStr).asInstanceOf[StructType]
    ...
    /*val rawDF = spark.read.format("org.apache.spark.sql.execution.datasources.json.JsonFileFormat").schema(requestStructType).option("multiLine", "true")
      .load("C:/Users/KPUVVAD/Desktop/Project/Project_Modules/MBLD/creditPlatform/Credit/Sample data/request_data.json")*/
    ...
    //accessing struct columns as below columnname.subcolumnname(struct element)
    rawDF.select("creditScore.scoringResponse.scoringId")
    rawDF.select(col("creditScore")("scoringResponse")("scoringId"))

    rawDF.select(col("creditScore")("scoringResponse")("scoringId"),explode(col("creditScore")("agencyData")("businessPartners")("businessPartnerNumber")).as("businessPartnerNumber")).show(2,false)





    //please comment for now
